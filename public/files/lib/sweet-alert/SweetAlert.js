...
const focusAutofocus = (domCache) => {
    ...
    for (const autofocusElement of autofocusElements) {
        if (
            ...
            dom.isVisible(autofocusElement)
        ) {
...
SweetAlert.prototype.showValidationMessage =
    instanceMethods.showValidationMessage;
SweetAlert.prototype.resetValidationMessage =
    instanceMethods.resetValidationMessage;
